...
export default function Navigation() {
  ...
  return (
    <nav className="bg-transparent backdrop-blur-md shadow-xl sticky top-0 z-50 border-b border-gray-800/50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          <div className="flex items-center">
            <div className="flex-shrink-0">
              <h1 className="text-[#2abdee] text-[40px] font-bold">CreativeEdge</h1>
            </div>
          </div>
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-secondary/90 backdrop-blur-md border-t border-gray-800/50">
              <button 
                onClick={() => scrollToSection('services')}
