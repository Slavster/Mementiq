...
const portfolioItems = [
  {
    ...
    thumbnail: "https://images.unsplash.com/photo-1488646953014-85cb44e25828?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=400&h=600",
  ...
  },
  {
    ...
    thumbnail: "https://images.unsplash.com/photo-1611162617474-5b21e879e113?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=400&h=600",
  ...
  },
  {
    ...
    thumbnail: "https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=400&h=600",
  ...
  },
  {
    ...
    thumbnail: "https://images.unsplash.com/photo-1465495976277-4387d4b0e4a6?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=400&h=600",
  ...
  },
  {
    ...
    thumbnail: "https://images.unsplash.com/photo-1574717024653-61fd2cf4d44d?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=400&h=600",
  ...
  },
  {
    ...
    thumbnail: "https://images.unsplash.com/photo-1560472354-b33ff0c44a43?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=400&h=600",
          ...
          <div className="relative w-full max-w-5xl h-full flex items-center justify-center">
            {portfolioItems.map((item, index) => {
              ...
              return (
                ...
                >
                  <div className={`relative rounded-xl overflow-hidden shadow-2xl border-2 transition-all duration-300 ${
                  ...
                  {isActive && (
                    <div className="mt-6 text-center">
                      <h3 className="text-xl font-semibold text-light mb-2">{item.title}</h3>
                      <p className="text-charcoal text-sm max-w-xs mx-auto">{item.description}</p>
                    </div>
                  )}
                </div>
              );
            ...
            {portfolioItems.map((_, index) => (
              <button
                ...
                className={`w-3 h-3 rounded-full transition-all duration-300 ${
                  index === selectedVideo ? 'bg-accent' : 'bg-gray-600 hover:bg-gray-500'
                }`}
              />
            ))}
          </div>
