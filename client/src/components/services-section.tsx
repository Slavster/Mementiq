...
const services = [
  {
    ...
    description:
      "Eye-catching edits perfect for Instagram, TikTok, YouTube, and other platforms that get you noticed.",
    features: [
  ...
  },
  {
    ...
    description:
      "Your special moments transformed into cinematic masterpieces - from travel vlogs, to community gatherings, important milestones, and once-in-a-lifetime events.",
    features: [
      "For the jet setter",
      "For the hobbyist",
  ...
  },
  {
    ...
    description:
      "Skip the editing headache and quickly transform your raw footage into high-converting ads and captivating content.",
    features: [
  ...
  },
  {
    ...
    description:
      "Bring your creative vision to life with professional editing that captures emotion and tells your story.",
    features: [
      "For the musician",
      "For the film maker",
      "For the artisan",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-charcoal max-w-3xl mx-auto">
            Bring your creative vision to life. <br />
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    zIndex,
                    opacity:
                      Math.abs(offset) > 1 ? 0 : Math.abs(offset) > 0 ? 0.7 : 1,
                  }}
                >
                    ...
                    <CardContent className="p-8">
                      <div className="flex items-start gap-4 mb-4">
                        <div className="flex-shrink-0 mt-1">
                          {service.iconName === "Smartphone" && (
                            <Smartphone
                              className={`h-8 w-8 ${service.iconColor}`}
                            />
                          )}
                          {service.iconName === "Gem" && (
                            <Gem className={`h-8 w-8 ${service.iconColor}`} />
                          )}
                          {service.iconName === "Megaphone" && (
                            <Megaphone
                              className={`h-8 w-8 ${service.iconColor}`}
                            />
                          )}
                          {service.iconName === "Palette" && (
                            <Palette
                              className={`h-8 w-8 ${service.iconColor}`}
                            />
                          )}
                      ...
                      <ul className="space-y-2">
                        {service.features.map((feature, featureIndex) => (
                          <li
                            key={featureIndex}
                            className="flex items-center text-charcoal font-medium text-[16px]"
                          >
