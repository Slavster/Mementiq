        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              <li><a href="#" className="hover:text-accent transition-colors duration-200">Social Media Content</a></li>
              <li><a href="#" className="hover:text-accent transition-colors duration-200">Personal Projects</a></li>
              <li><a href="#" className="hover:text-accent transition-colors duration-200">Creative Storytelling</a></li>
              <li><a href="#" className="hover:text-accent transition-colors duration-200">Music Videos</a></li>
            </ul>
          </div>
